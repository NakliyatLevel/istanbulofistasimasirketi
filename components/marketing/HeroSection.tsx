          ...
          <div className="max-w-3xl">
            ...
            <div className="mt-6 space-y-3">
              ...
              <div className="text-[1.15rem] md:text-[1.45rem] font-semibold text-foreground">
                Kurumsal ofislerinizi eksiksiz ve güvenle yeni adresine taşıyoruz.
              </div>

              <p className="text-base md:text-lg text-muted-foreground leading-relaxed max-w-2xl">
                İstanbul Ofis Taşıma Şirketi, kurumsal taşınma süreçlerinde planlamadan montaja kadar tüm adımları tek elden yönetir,
                BT altyapınızı koruyarak iş sürekliliğinizi kesintiye uğratmadan profesyonel taşıma sunar.
              </p>
            </div>
