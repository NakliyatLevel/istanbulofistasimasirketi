...
const serviceIconMap: Record<string, LucideIcon> = {
  'ev-tasima': Home,
  'villa-tasimaciligi': Building2,
  'yali-tasimaciligi': Anchor,
  'parca-esya-tasimaciligi': Package,
  'sehir-ici-ofis-tasimaciligi': MapPin,
  'sehirler-arasi-ofis-tasimaciligi': Route,
  'sehir-ici-evden-eve-nakliyat': Route,
  'sehir-ici-nakliyat': Route,
  'sehirler-arasi-evden-eve-nakliyat': Route,
  'sehirler-arasi-nakliyat': Route,
